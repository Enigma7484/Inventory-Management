      ...
      <Card cardClass={"card"}>
        <form onSubmit={saveProduct}>
          <div className="form-grid">
            <Card cardClass={"group image-group"}>
              <div>
              ...
              <label className="upload-control">
                ...
                <input type="file" name="image" accept=".jpg,.jpeg,.png,image/jpeg,image/png" onChange={(e) => handleImageChange(e)} />
              </label>
              {imagePreview != null ? (
                <div className="image-preview">
                  <img src={imagePreview} alt="product" />
                </div>
              ) : (<p className="form-muted">No image set for this product.</p>)}
            </Card>
